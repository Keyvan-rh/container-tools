...
DEL: Notice that the name of the container being built is "ubi-init-working-container-2".  The suffix "-working-container" is always added.  Any training digits will be present if an earlier container of the same name was constructed.  In my notes, I am creating my third image here.
...
```
image::httpd-valid.png[1000,1000]
...
image::id-in-user.png[1000,1000]
...
image::inspect-crio.png[1000,1000]
